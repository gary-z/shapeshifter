...
- Each cell stores its deficit: the number of hits still needed to reach 0. When a piece is placed, each covered cell's deficit is decremented by 1 (mod M). A cell at deficit 0 wraps to M-1.
