...
- Each cell's deficit is `(M - value) % M`: the number of hits still needed to reach 0. When a piece is placed, each filled cell's deficit is decremented by 1 (mod M).
